...
"""
测试browser-use内容提取功能（从.env文件读取环境变量）

此脚本用于测试使用browser-use库进行网页内容提取，支持从.env文件读取环境变量
"""
...
def test_browser_use(test_url=None):
    """
    ...
    if not os.environ.get("OPENAI_API_KEY"):
        ...
        print("请在项目根目录创建.env文件并设置OPENAI_API_KEY")
        print("例如: OPENAI_API_KEY=your_api_key_here")
        return
...
if __name__ == "__main__":
    ...
    # 运行测试
    test_browser_use(test_url=args.url) 